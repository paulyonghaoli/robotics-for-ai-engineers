...
GATES = [
    ...
    ("grader:deployment", [PY, "-m", "grader", "--reference", "--seed", "1"],
     ROOT / "projects" / "deployment_mini"),
    ("grader:learning", [PY, "-m", "grader", "--reference", "--seed", "1"],
     ROOT / "projects" / "learning_mini"),
    ...
    ("capstone2:gate", [PY, "solutions/gate.py", "--episodes", "24"],
     ROOT / "projects" / "capstone_ship"),
    ("capstone2:engine", [PY, "solutions/data_engine.py", "--rounds", "1",
                          "--train-episodes", "10", "--mine-episodes", "6",
                          "--eval-episodes", "6", "--coreset", "400"],
     ROOT / "projects" / "capstone_ship"),
    ("capstone2:rollout", [PY, "solutions/rollout.py", "--episodes", "6"],
     ROOT / "projects" / "capstone_ship"),
    ("capstone2:report", [PY, "solutions/report.py", "--episodes", "8"],
     ROOT / "projects" / "capstone_ship"),
