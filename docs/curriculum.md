...
| Module | Contents | Status |
|---|---|---|
| [**7 · Robotic perception**](modules/07-perception/index.md) | Camera models, stereo & depth, point clouds, registration, 3D detection, BEV, fusion | 🔨 3 lessons + [autograded project](modules/07-perception/project-perception.md) |
