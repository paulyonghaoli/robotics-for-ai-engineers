...
| [**13 · Systems performance**](modules/13-systems-perf/index.md) | The **C++ track** (ports with parity checks against the Python references), the GPU performance model, real-time constraints | 🔨 4 lessons |
